...
import kotlinxdatetimefun.calendar.extensions.toLocalDate
import kotlinxdatetimefun.date.extensions.toLocalDate
...
class LocalDateUtilTest {
    ...
    fun `given date epoch millisecond, when converted to localDateTime, then should match attributes`() {
        ...
        // when
        val localDate = kotlinxdatetimefun.localdate.LocalDateUtil.new(epoch)
